...
classFile = 'object_recognition/coco.names'
with open(classFile, 'rt') as f:
    classNames = f.read().rstrip('\n').split('\n')

configPath = 'object_recognition/ssd_mobilenet_v3_large_coco_2020_01_14.pbtxt'
weightPath = 'object_recognition/frozen_inference_graph.pb'
